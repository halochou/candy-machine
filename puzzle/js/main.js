...
game.States.main = function() {
    ...
    this.create = function() {
        ...
        this.leftTime = 500
        var style = { font: "bold 22px Microsoft Yahei", fill: "#000" };
        jinduWord = game.add.text(400, 1, this.leftTime +" s Left", style);
        ...
        for(var i in sort){
            ...
            // item.events.onInputDown.add(pair, this);
    ...
    this.refreshTime = function(){
        this.leftTime--;
        jinduWord.text = this.leftTime +"s Left";
        if(this.leftTime === 0) {
                    ...
                    if(item.nowSort === newSort && ifMoveEnd === true){
                        ...
                        tween.onComplete.add(function(){
                            ...
                            if(t.checkSort()){
                                ...
                                if(window.confirm("Redeem?")){
                                    redeem(game.state.ble);
                                } else {
                                    game.state.restart();
                                }
                            }
